...
description: Richard Feynman's three-step approach to problem solving — write down the problem, think very hard, write down the solution.
draft: true
featured: false
image:
...
A key competency is **decomposing complex problems** and **rallying teams** to address their **root cause** in a **structured manner.** In my experience, the most challenging step in addressing the root cause of a problem is often the definition of the problem in the first place.
