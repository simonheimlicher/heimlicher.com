...
{{<responsive-image caption="Navigating to `/usr/libexec/configd`" src="images/navigate_to_configd.png" >}}

{{<responsive-image caption="Successfully added `/usr/libexec/configd`'" src="images/configd_added.png" >}}
